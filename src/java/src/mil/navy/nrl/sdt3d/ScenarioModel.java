...
public class ScenarioModel
{
	...
	*/
	private LinkedHashMap<Long,Map<Integer,String>> sdtCommandMap = 
			new LinkedHashMap<Long, Map<Integer,String>>();
	 ...
	 * must be accomplished through the returned map.
	 */
	private Map<Long, Map<Integer, String>> synSdtCommandMap = 
			Collections.synchronizedMap(sdtCommandMap);
		
	/*
	* LinkedHashMap maintains insertion order
	*/
	private LinkedHashMap<Long,Map<Integer,String>> sdtBufferCommandMap = 
			new LinkedHashMap<Long, Map<Integer,String>>();
	 ...
	 * must be accomplished through the returned map.
	 */
	private Map<Long, Map<Integer, String>> synSdtBufferCommandMap = 
			Collections.synchronizedMap(sdtBufferCommandMap);
	...
	void loadRecording(String scenarioFileName)
	{
		try {				
			...
			System.out.println("loadRecording() sdtCommandMap loaded in> " + 
			...
			System.out.println("loadRecording() Created syncrhonized sdtCommandmap in: " 
					+ interval.getSeconds() + " seconds");
	...
	void appendBufferModel()
	{
		synchronized(synSdtBufferCommandMap)
		{
			synchronized(synSdtCommandMap) 
			{
				...
				System.out.println("Appending synSdtBufferCommandMap.size()>" + synSdtBufferCommandMap.size());
